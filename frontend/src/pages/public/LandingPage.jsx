...
const testimonials = [
  {
    ...
    quote: 'The lessons are structured perfectly. I went from struggling with basic ragas to playing full krithis in just a few months.',
  },
  {
    name: 'Arjun M.',
    course: 'Piano',
    quote: 'My teacher made complex theory feel approachable. The practice notes after each class are incredibly helpful.',
  },
  {
    name: 'Kavitha R.',
    course: 'Carnatic Vocals',
    quote: 'Online classes that feel personal. The flexibility to learn at my own pace while getting expert feedback is amazing.',
  },
];
...
export default function LandingPage() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="relative min-h-[60vh] flex items-center bg-gradient-to-b from-primary-400 via-primary-200 to-primary-50 overflow-hidden">
        ...
        <img src={logo} alt="Chord Compass" className="hidden lg:block absolute left-[5%] top-1/2 -translate-y-1/2 w-[56rem] z-10" />
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 w-full">
          <div className="flex items-center justify-end">
            <div className="max-w-2xl lg:max-w-lg">
              <h1 className="font-heading text-5xl md:text-7xl font-bold text-neutral-900 leading-none mb-6">
                Learn<br />
      ...
      <section id="courses" className="py-20 bg-neutral-50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            <h2 className="font-heading text-4xl font-bold text-neutral-900 mb-3">What You'll Learn</h2>
            <p className="text-neutral-500 text-lg max-w-xl mx-auto">
              Four disciplines, one goal — helping you discover and develop your musical voice.
            </p>
          </div>
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="rounded-3xl h-80 overflow-hidden flex justify-end" style={{ backgroundColor: '#F5EDDA' }}>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center p-4 rounded-xl bg-primary-50">
                  <p className="font-heading text-2xl font-bold text-primary-600">4</p>
                  <p className="text-sm text-neutral-500">Disciplines</p>
                </div>
                <div className="text-center p-4 rounded-xl bg-secondary-50">
                  <p className="font-heading text-2xl font-bold text-secondary-600">Online</p>
